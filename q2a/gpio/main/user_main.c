...
/* CHANGES IN FREERTOS CONFIGURATION
#define configUSE_PREEMPTION		1, enables preemptive scheduling for round robin scheduling
# define configUSE_TIME_SLICING 1, allow task switches per rtos tick
*/
/* OTHER CHANGES
Task priorities are now all the same level which allows for round robin scheduling
...
#define PRINTSTATS_PRIORITY	1 // Print Runtime Stats assigned same priority as other tasks
